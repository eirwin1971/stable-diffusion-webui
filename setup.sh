...
sudo cp v2-inference.yaml stable-diffusion-webui/models/Stable-diffusion/v2-1_512-ema-pruned.yaml

#cd to extensions and run: git clone https://github.com/yfszzx/stable-diffusion-webui-images-browser
